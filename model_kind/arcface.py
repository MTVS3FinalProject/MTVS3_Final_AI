...
def get_face_embedding(image):
    try:
        ...
        # 얼굴 임베딩 추출 (ArcFace 모델 사용)
        embedding = DeepFace.represent(img_path=img, model_name="ArcFace", enforce_detection=False)
...
# uvicorn MTVS3_Final_AI.model_kind.arcface:app --reload --port 8090
